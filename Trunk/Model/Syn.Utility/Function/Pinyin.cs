namespace Syn.Utility.Function
{
    ...
    public class Pinyin
    {
        ...
        { 
            ...
            "C嚓擦礤礸遪猜才长材财財戝裁采倸埰婇寀彩採睬跴綵踩菜棌蔡縩乲参飡骖湌嬠餐驂残蚕惭殘慚蝅慙蠶蠺惨慘噆憯黪黲灿粲儏澯薒燦璨爘仓仺伧沧苍倉舱傖凔嵢滄獊蒼濸艙螥罉藏欌鑶賶撡操"   , 
            ...
            "Z綻嶘輚戰虥虦覱轏蘸驏张弡張章傽鄣嫜彰慞漳獐粻蔁遧暲樟璋餦蟑鏱騿鱆麞仉涨涱掌漲幥礃鞝鐣丈仗扙账杖胀账粀帳脹痮障墇嶂幛賬瘬瘴瞕佋钊妱巶招昭炤盄釗啁鉊駋窼鍣爫找沼瑵召兆"   , 
        ...
        public static string GetChineseSpell(string strText)
        {
            ...
            else if (StrChineseCharList[0].IndexOf(vChar) > 0)
            {
                myStr.Append(StrChineseCharList[0][0]);
            }
            else
            {
                myStr.Append(char.ToUpper(vChar));
