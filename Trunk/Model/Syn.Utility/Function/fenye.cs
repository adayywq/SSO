...
namespace Syn.Utility.Function
{
   public class fenye
    {
       //private static Syn.Utility.DBHelper.OrclHelper OracleRead = Syn.Utility.DBHelper.OrclHelper.SSORead;
       //private static Syn.Utility.DBHelper.OrclHelper OracleWrite = Syn.Utility.DBHelper.OrclHelper.SSOWrite;
       public DbDataReader pagefenye(string tableName, string pK, string sortField, int curr, int pagesize, string FieldCount, string where, string order, string isCount)
       {
           ...
           try
           {
               dsOrclUser = OrclHelper.SSORead.ExecuteReader(sqlUser,CommandType.Text,paramUser);
           }
           catch (Exception ex)
           {
       ...
       public DataTable pagefenyeset(string tableName, string pK, string sortField, int curr, int pagesize, string FieldCount, string where, string order, string isCount)
       {
           ...
           try
           {
               ...
               dsOrclUser = OrclHelper.SSORead.ExecuteDataSet(sqlUser);
           }
           catch (Exception ex)
           {
               Log.WriteErrorLog(ex, "张晶", "分页");
       ...
       public int fenyecountfi(string tableName, string id, string where)
       {
           ...
           try
           {
               dsOrclUser = OrclHelper.SSORead.ExecuteDataSet(sqlUser, CommandType.Text, paramUser);
           }
           catch (Exception ex)
           {
               Log.WriteErrorLog(ex, "张晶", "分页统计总行数");
